 ...
 */
public class UnimplementedException extends Unimplemented {
    private static final long serialVersionUID = 1L;

    public UnimplementedException(Throwable e) {
        super(e);
    }

    public UnimplementedException(String message, Throwable e) {
        super(message, e);
    }
}
