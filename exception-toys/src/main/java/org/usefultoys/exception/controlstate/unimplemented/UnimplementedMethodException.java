 ...
 */
package org.usefultoys.exception.controlstate.unimplemented;
...
public class UnimplementedMethodException extends UnimplementedConstrolStateException {
	...
	public UnimplementedMethodException() { super(); }
	public UnimplementedMethodException(String message) { super(message); }
}
