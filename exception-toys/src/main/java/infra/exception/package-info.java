 ...
 * <p/>
 * O método {@link infra.exception.ExceptionService#reportException(java.io.PrintStream, Throwable)} é
 ...
 * <p/>
 * Por conveniência, os métodos {@link infra.exception.ExceptionService#install()} define na JVM um handler padrão de exceção
 * que reporta uma exceção não tratada através do método  {@link infra.exception.ExceptionService#reportException(java.io.PrintStream, Throwable)}
